          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-muted pr-0" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <span class="avatar avatar-sm mt-2">
                <img src="<?=base_url('assets/tiny/')?>/assets/avatars/pp.jpg" alt="..." class="avatar-img rounded-circle">
              </span>
            </a>
				...
				<ul class="navbar-nav flex-fill w-100 mb-2">
					<li class="nav-item dropdwon ">
						<a href="<?= base_url('admin/caraousel')?>" class="nav-link">
							...
							<span class="ml-3 item-text">Caraousel</span>
						</a>
					</li>
					<li class="nav-item w-100">
						<a class="nav-link" href="<?= base_url('admin/kategori')?>">
							<i class="fe fe-calendar fe-16"></i>
							<span class="ml-3 item-text">Kategori Konten</span>
						</a>
					</li>
					<li class="nav-item dropdown ">
						<a href="<?= site_url('admin/konten')?>" class="nav-link">
							<i class="fe fe-settings fe-16"></i>
							<span class="ml-3 item-text">Konten</span>
						</a>
					</li>
